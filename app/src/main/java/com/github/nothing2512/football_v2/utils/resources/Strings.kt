...
object Strings {
    ...
    const val APP_NAME = "Football"
    const val APP_DESC = "lorem ipsum dolor sit amet"
    const val DESCRIPTION_SUB_TITLE = "description"
    const val PREVIUS_EVENT = "Previus Event"
    const val NEXT_EVENT = "Next Event"
    const val FIRST_EVENT = "First Event"
    const val GENDER = "Gender"
    const val COUNTRY = "Country"
    const val TEAM_COLUMN = "team"
    const val SCORE_COLUMN = "score"
    const val FOUL_COLUMN = "foul"
    const val ROUND_COLUMN = "round"
