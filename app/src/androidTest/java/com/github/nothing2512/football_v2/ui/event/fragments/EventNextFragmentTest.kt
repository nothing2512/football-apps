...
class EventNextFragmentTest {
    ...
    @Test
    fun loadNextEvent() {
        onView(withId(R.id.btStateNext)).perform(click())
        onView(withId(R.id.eventRecyclerView)).check(RecyclerViewAssertions(TestUtil.NEXT_EVENT_COUNT))
    }
}