...
import com.github.nothing2512.football_v2.utils.viewmodel.LovedViewModelUtil
...
class KoinRule : TestWatcher() {
    ...
    val lovedViewModel = LovedViewModelUtil()
        ...
        startKoin {
            modules(
                module {
                    ...
                    viewModel { lovedViewModel as LovedViewModel }
                }
            )
        }
    }
